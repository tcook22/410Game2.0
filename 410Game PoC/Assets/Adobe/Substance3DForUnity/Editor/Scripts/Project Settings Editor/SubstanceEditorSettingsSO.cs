...
namespace Adobe.Substance.Editor.ProjectSettings
{
    ...
    internal class SubstanceEditorSettingsSO : ScriptableObject
    {
        ...
        [SerializeField]
        private Vector2Int _cpuEngineMaxResolution;
        ...
        internal static SubstanceEditorSettingsSO GetOrCreateSettings()
        {
            ...
            if (settings == null)
            {
                ...
                settings._cpuEngineMaxResolution = new Vector2Int(12, 12);
        ...
        public static Vector2Int CPUEngineMaxResolution()
        {
            var settigns = GetOrCreateSettings();
            return settigns._cpuEngineMaxResolution;
        }
